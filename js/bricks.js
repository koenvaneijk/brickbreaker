...
class BrickManager {
    ...
    generateLevel(difficulty = 1) {
        ...
        // Make sure bricks fit within the game width with some margin
        const maxCols = Math.floor((gameWidth - 1) / 2);
        const cols = Math.max(5, Math.min(maxCols, Math.floor(gameWidth / 2)));
